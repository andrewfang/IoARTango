...
public class PlaneFittingActivity extends Activity implements View.OnTouchListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        RelativeLayout.LayoutParams editTextLayout = new RelativeLayout.LayoutParams(300,300);
        mEditText = new EditText(this);
        mEditText.setLayoutParams(editTextLayout);
        mEditText.setHint("Text here");
        ...
        b.setLayoutParams(new RelativeLayout.LayoutParams(100, 100));
